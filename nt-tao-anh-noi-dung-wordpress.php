...
define( 'NT_CONTENT_IMAGES_VERSION', '0.17.0' );
...
require_once NT_CONTENT_IMAGES_PATH . 'includes/brief/class-nt-content-images-plan-settings.php';
require_once NT_CONTENT_IMAGES_PATH . 'includes/brief/class-nt-content-images-plan-overrides.php';
...
require_once NT_CONTENT_IMAGES_PATH . 'includes/generation/class-nt-content-images-caption-writer.php';
...
require_once NT_CONTENT_IMAGES_PATH . 'includes/templates/class-nt-content-images-template-pack-registry.php';
